...
.PHONY: gen-handler
gen-handler:
	oapi-codegen -package handler -generate "types" -templates apitemplates go.yaml > api/types.gen.go
	oapi-codegen -package handler -generate "chi-server" -templates apitemplates go.yaml > api/handler_wrapper.gen.go
